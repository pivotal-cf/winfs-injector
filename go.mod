...
require (
	...
	github.com/cloudfoundry/bosh-davcli v0.0.161 // indirect
	github.com/cloudfoundry/bosh-gcscli v0.0.108 // indirect
	github.com/cloudfoundry/bosh-s3cli v0.0.178 // indirect
	github.com/cloudfoundry/config-server v0.1.105 // indirect
