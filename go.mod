...
require (
	...
	github.com/cloudfoundry/bosh-agent/v2 v2.749.0 // indirect
	github.com/cloudfoundry/bosh-davcli v0.0.421 // indirect
	github.com/cloudfoundry/bosh-gcscli v0.0.305 // indirect
